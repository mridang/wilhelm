...
#     Tags every submodule on the current commit and pushes the tags.
#     This step is intentionally deferred to publishCmd so the tags point
#     at the release commit that @semantic-release/git already created in
#     the prepare phase.
#
...
# whichever wilhelm checkout invoked it.
ROOT=$(pwd)
